...
def main():
    ...
    parser.add_argument("--config_file", "-cfg", default="experiments/exploration/pointmass_easy_rnd.yaml",)#type=str, required=True)
    ...
    parser.add_argument("--dataset_dir", default="datasets/",)#type=str, required=True)
