...
def sample_trajectory(env, policy, max_path_length, render=False):
    ...
    while True:
        ...
        ac = ptu.to_numpy(policy(ob)) #TODO # HINT: this is a numpy array
        #print(ac.shape)
        #ac = ac[0]
        ...
        # # Check the action space type and dimensions
        # if isinstance(action_space, gym.spaces.Box):
        #     # If the action space is a Box (continuous action space)
