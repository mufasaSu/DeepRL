...
def run_training_loop(config: dict, logger: Logger, args: argparse.Namespace):
    ...
    for step in tqdm.trange(config["total_steps"], dynamic_ncols=True):
        ...
        #TODO:(student): apply Hint
        # If trajectory is truncated, done flag should be False for TD-updates
...
def main():
    ...
    parser.add_argument("--config_file", "-cfg", type=str, default="experiments/dqn/mspacman.yaml")#required=True)

    parser.add_argument("--eval_interval", "-ei", type=int, default=10000)
    parser.add_argument("--num_eval_trajectories", "-neval", type=int, default=10)
    parser.add_argument("--num_render_trajectories", "-nvid", type=int, default=0)

    parser.add_argument("--seed", type=int, default=3) # zuletzt ausgeführt: 3
